...
_include beep context dev logging net paths platform wait
: ${_CONF_LOG_HEADER:="##################################################"}
...
_REQUIRED_APP_CONF="_CONF_GNU_GREP _CONF_LOG_BEEP_ALRT _CONF_LOG_BEEP_DEBUG _CONF_LOG_BEEP_DETAIL _CONF_LOG_BEEP_ERR _CONF_LOG_BEEP_INFO _CONF_LOG_BEEP_SCS _CONF_LOG_BEEP_STDIN _CONF_LOG_BEEP_WRN"
...
_waitee_init
_waiter
detail "Preventing Hibernate from logging to stdout"
