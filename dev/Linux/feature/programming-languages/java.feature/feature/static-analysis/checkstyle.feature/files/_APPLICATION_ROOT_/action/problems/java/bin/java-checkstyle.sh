...
_include
: ${_CONF_DEV_CHECKSTYLE_VERSION:=12.2.0}
: ${_CONF_DEV_CHECKSTYLE_VERSION_STYLE:=google}
: ${_CONF_DEV_CHECKSTYLE_JAR:=$_CONF_APPLICATION_LIBRARY_PATH/checkstyle/checkstyle.jar}
: ${_CONF_DEV_CHECKSTYLE_CONFIG:=$_CONF_APPLICATION_LIBRARY_PATH/checkstyle/checks/$_CONF_DEV_CHECKSTYLE_VERSION_STYLE_checks.xml}_REQUIRED_APP_CONF=""
trap _on_hup 1
trap _on_int 2
trap _on_quit 3
trap _on_illegal 4
...
_waiter
_sub_platform
java -jar $_CONF_DEV_CHECKSTYLE_JAR -c $_CONF_DEV_CHECKSTYLE_CONFIG "$@"
