...
Linux | FreeBSD)
  _CONFIGURATION_DIRECTORY=$HOME/.config/chromium
  ;;
*)
...
_CONFIGURATION_DIRECTORY=$HOME/.config/chromium
: ${conf_web_browser_chromium_cmd:=chrome}
