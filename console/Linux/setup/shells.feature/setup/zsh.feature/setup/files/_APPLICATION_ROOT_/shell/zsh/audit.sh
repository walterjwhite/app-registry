...
: ${APP_CONTEXT:=default}
: ${conf_console_zsh_session_history_size:=1000}
: ${conf_console_zsh_disk_history_size:=1000}
: ${conf_console_shell_cmd:=/usr/bin/zsh}
CONF_LOG_HEADER="##################################################"
: ${conf_log_c_err:="1;31"}
: ${conf_log_c_scs:="1;32"}
: ${conf_log_c_wrn:="1;33"}
...
export HISTSIZE=$conf_console_zsh_session_history_size
export SAVEHIST=$conf_console_zsh_disk_history_size
autoload -U add-zsh-hook
add-zsh-hook precmd _console_zsh_hook_after
add-zsh-hook preexec _console_zsh_hook_before
