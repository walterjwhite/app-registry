...
_include logging platform context wait beep paths net git
: ${_CONF_LOG_HEADER:="##################################################"}
...
: ${_CONF_GIT_SMOKE_COMMITS:=5}
: ${_CONF_GIT_SMOKE_ITERATIONS:=1}
: ${_CONF_GIT_SMOKE_SLEEP_DURATION:=86400}
: ${_CONF_GIT_TEMPLATE_PATH:=/Library/Develop/CommandLineTools/usr/share/git-core/templates}
...
_REQUIRED_APP_CONF="_CONF_INSTALL_APPLE_BEEP_MESSAGE _CONF_INSTALL_APPLE_SUDO_PRECMD_MESSAGE"
