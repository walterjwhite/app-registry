...
_GSETTINGS_GNOME_DESKTOP_INTERFACE_KEY=org.gnome.desktop.interface
_CONFIGURE_GNOME_DESKTOP_INTERFACE_BACKUP() {
  _gsettings_dump $_GSETTINGS_GNOME_DESKTOP_INTERFACE_KEY
}
_CONFIGURE_GNOME_DESKTOP_INTERFACE_RESTORE() {
  _gsettings_restore $_GSETTINGS_GNOME_DESKTOP_INTERFACE_KEY
}
_CONFIGURE_GNOME_DESKTOP_INTERFACE_CLEAR() {
  :
}
