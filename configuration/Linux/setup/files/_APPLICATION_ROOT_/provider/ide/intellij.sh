...
Windows)
  _conf_intellij_get_directory ${alt_path}$HOME/AppData/IntelliJ
  ;;
Apple)
  _conf_intellij_get_directory ${alt_path}$HOME/Library/"Application Support"/JetBrains
  ;;
Linux | FreeBSD)
  _conf_intellij_get_directory ${alt_path}$HOME/.config/JetBrains
  ;;
esac
